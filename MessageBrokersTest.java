...
class Partition {
    ...
    public String toString() {
        ...
        sb.append("Messages:\n");
        String messagesStr = messages.stream().map(Message::toString).collect(Collectors.joining("\n"));
...
class Topic {
    ...
    public String toString() {
        ...
        String partitionsStr = partitions.values().stream().map(Partition::toString).collect(Collectors.joining("\n"));
...
class MessageBroker {
    ...
    public String toString() {
        ...
        String topicsStr = topics.values().stream().map(Topic::toString).collect(Collectors.joining("\n"));
        sb.append(topicsStr);
        return sb.toString();
    }
}
